        ...
        while (1) {
            ...
            if (pass_counter++ > INTERRUPT_COUNT) {
               ...
               (first_sp->port.pb_info.vendor_id == VENDOR_ID_WCH_PCIE &&
                first_sp->port.pb_info.device_id == DEVICE_ID_WCH_CH384_8S) ||
               (first_sp->port.pb_info.vendor_id == VENDOR_ID_WCH_PCIE &&
                first_sp->port.pb_info.device_id == DEVICE_ID_WCH_CH384_20S) ||
               (first_sp->port.pb_info.vendor_id == VENDOR_ID_WCH_PCIE &&
                first_sp->port.pb_info.device_id == DEVICE_ID_WCH_CH384_8HS) ||
               (first_sp->port.pb_info.vendor_id == VENDOR_ID_WCH_PCIE &&
                first_sp->port.pb_info.device_id == DEVICE_ID_WCH_CH384_10HS) ||
               (first_sp->port.pb_info.vendor_id == VENDOR_ID_WCH_PCIE &&
                first_sp->port.pb_info.device_id == DEVICE_ID_WCH_CH384_16HS)) {
        while (1) {
            ...
            if ((irqbits & 0x40000000) == 0) {
                ...
                if (ch438irqbits != 0) {
                    if (first_sp->port.pb_info.device_id == DEVICE_ID_WCH_CH384_28S ||
                        ...
                        index_start = 0;
                        index_end = 0x08;
                    } else if (first_sp->port.pb_info.device_id == DEVICE_ID_WCH_CH384_16HS) {
                        sp--;
                        index_start = 1;
                        index_end = 0x06;
                    }
            ...
            if ((irqbits & 0x20000000) == 0) {
                ...
                if (ch438irqbits != 0) {
                    if (first_sp->port.pb_info.device_id == DEVICE_ID_WCH_CH384_28S ||
                        ...
                        index_start = 0;
                        index_end = 0x08;
                    } else if (first_sp->port.pb_info.device_id == DEVICE_ID_WCH_CH384_8HS) {
                        index_start = 2;
                        index_end = 0x06;
                    } else if (first_sp->port.pb_info.device_id == DEVICE_ID_WCH_CH384_10HS) {
                        index_start = 1;
                        index_end = 0x07;
                    } else if (first_sp->port.pb_info.device_id == DEVICE_ID_WCH_CH384_16HS) {
                        index_start = 1;
                        index_end = 0x08;
                    } else if (first_sp->port.pb_info.device_id == DEVICE_ID_WCH_CH384_8S) {
                        index_start = 0;
                        index_end = 0X08;
                    }
